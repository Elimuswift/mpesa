...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Mpesa security credential
    |--------------------------------------------------------------------------
    | Security credentials are generated by encrypting the base64 encoded
    | initiator password with M-Pesa’s public key, a X509 certificate.
    |
     */
    'securityCredential' => '',
